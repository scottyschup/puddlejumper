...
ActiveRecord::Schema.define(version: 20150408224606) do
  ...
  add_index "trips", ["trip_date"], name: "index_trips_on_trip_date", using: :btree
  add_index "trips", ["trip_time"], name: "index_trips_on_trip_time", using: :btree
